...
@BaseClient.on(X_cmd(pattern="batmandp$"))
...
@BaseClient.on(X_cmd(pattern="thordp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="actressdp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="animedp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="avengersdp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="gamerdp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="hackerdp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="spacedp$"))
async def main(event):
...
@BaseClient.on(X_cmd(pattern="wallpapers$"))
async def main(event):
