# Not Used in this userbot used for other 👤 userbots 
...
if ENV:
    ...
    class Config(object):
        ...
        # set blacklist_chats where you do not want Speedo's features
        UB_BLACK_LIST_CHAT = set(int(x) for x in os.environ.get("BLOCKLIST", "").split())
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Hobby-Dev-0/X"
        )
        PM_DATA = os.environ.get("PM_DATA", "ENABLE")
